...
void MainWindow::connectSignals()
{
	...
	connect(m_ui.actionPatreon, &QAction::triggered, this, &MainWindow::onPatreonActionTriggered);
...
void MainWindow::updateWindowTitle()
{
	...
	{
#if defined(_DEBUG)
		title = QStringLiteral("AetherSX2 [Debug] %1").arg(GIT_REV);
#else
		title = QStringLiteral("AetherSX2 %1").arg(GIT_REV);
#endif
	}
	else
	{
...
void MainWindow::onPatreonActionTriggered()
{
	QtUtils::OpenURL(this, AboutDialog::getPatreonUrl());
}

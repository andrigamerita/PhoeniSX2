...
{
public:
	GSDrawScanlineCodeGenerator2(vixl::aarch64::MacroAssembler& armAsm_, void* param, u64 key);
	void Generate();
...
private:
	...
	void WritePixel_NEON(const vixl::aarch64::VRegister& src, const vixl::aarch64::WRegister& addr, u8 i, int psm);
	void ReadTexel_NEON(int pixels, int mip_offset = 0);
	void ReadTexel_NEON(const vixl::aarch64::VRegister& dst, const vixl::aarch64::VRegister& addr, u8 i);

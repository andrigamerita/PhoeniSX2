...
#ifdef _M_ARM64
	alignas(16) u8 m_lohi_shuffle_2200[16] = { 0, 1, 0, 1, 4, 5, 4, 5, 8, 9, 8, 9, 12, 13, 12, 13 };
	alignas(16) u8 m_lohi_shuffle_2222[16] = { 4, 5, 4, 5, 4, 5, 4, 5, 12, 13, 12, 13, 12, 13, 12, 13 };
	alignas(16) u8 m_hi_shuffle_2222[16] = { 0, 1, 2, 3, 4, 5, 6, 7, 12, 13, 12, 13, 12, 13, 12, 13 };
	alignas(16) u8 m_lohi_shuffle_3311[16] = { 2, 3, 2, 3, 6, 7, 6, 7, 10, 11, 10, 11, 14, 15, 14, 15 };
#endif

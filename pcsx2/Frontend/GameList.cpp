...
void GameList::Refresh(bool invalidate_cache, ProgressCallback* progress /* = nullptr */)
{
	...
	std::vector<std::string> recursive_dirs(Host::GetStringListSetting("GameList", "RecursivePaths"));

#ifdef __ANDROID__
	recursive_dirs.push_back(Path::CombineStdString(EmuFolders::DataRoot, "games"));
#endif
